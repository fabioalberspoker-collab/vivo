...
import { GeminiService, type ContractAnalysisResult } from '@/services/ai/geminiService';
import type { Contract } from '@/data/mockContracts';
import type { ContractFromDB } from '@/domains/contracts/hooks/useContractFilters';
import type { BatchAnalysisResult, AnalysisResult } from '@/services/ai/contractAnalysisService';
